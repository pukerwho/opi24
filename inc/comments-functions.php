...
{
    echo '<div class="comment-form-comment mb-2"><textarea id="comment" name="comment" rows="4" placeholder="Ваш комментарий" aria-required="true" class="w-full text-gray-800 border rounded border-gray-200 py-2 px-4 mb-2"></textarea></div>';
}
